...
my_vcf_files <- list.files(path = "~/wkspace/r-novice-gapminder/data/",pattern = "\\.vcf")
...
Building off what's we've learned today, create your own analysis as a stand alone reproducible markdown document. You should use any element of what we've done so far. It should have the following elements.

*Goals* 

1. Should be completely reproducible
2. Code chunks should be properly labeled
3. The document should have several figures
4. Each figure should support an accompanying piece of analysis
